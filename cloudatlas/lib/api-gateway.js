...
class ApiGateway extends AWSComponent {
  ...
  */
   ...
   * Exact format please check https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-swagger-extensions-integration-responses.html
   {
     "<regPattern or default>" : {
        "statusCode": 200,
